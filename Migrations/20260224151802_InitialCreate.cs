        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveMarker = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Loans", x => x.Id);
                    table.CheckConstraint("CK_Loans_ActiveMarker", "ActiveMarker IS NULL OR ActiveMarker = 1");
                    table.CheckConstraint("CK_Loans_DueDate", "DueDate >= LoanDate");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Loans_BookCopyId_ActiveMarker",
                table: "Loans",
                columns: new[] { "BookCopyId", "ActiveMarker" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Loans_MemberId_LoanDate",
                table: "Loans",
                columns: new[] { "MemberId", "LoanDate" });
